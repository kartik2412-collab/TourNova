...
export const auditActions = {
  ...
  PRICE_REPORT_SUBMITTED: "PRICE_REPORT_SUBMITTED",
  PRICE_REPORT_DECIDED: "PRICE_REPORT_DECIDED",
  CROWD_REPORT_SUBMITTED: "CROWD_REPORT_SUBMITTED",
  CROWD_REPORT_DECIDED: "CROWD_REPORT_DECIDED",
  ...
  INGESTION_BATCH_DECIDED: "INGESTION_BATCH_DECIDED",
